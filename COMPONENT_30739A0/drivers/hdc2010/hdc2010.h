...
static uint8_t wiced_hdc2010_read_reg(uint8_t reg);             // Reads a given register, returns 1 byte
static void wiced_hdc2010_write_reg(uint8_t reg, uint8_t data); // Writes a byte of data to one register
